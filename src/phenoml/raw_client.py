...
class Rawphenoml:
    ...
    ) -> HttpResponse[PostLang2FhirProfileUploadResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=PostLang2FhirProfileUploadResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawphenoml:
    ...
    async def upload_custom_fhir_profile(
        self, *, version: str, resource: str, profile: str, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[PostLang2FhirProfileUploadResponse]:
        """
        Upload a custom FHIR StructureDefinition profile for use with the lang2fhir service
