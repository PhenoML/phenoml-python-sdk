...
def test_summary_get_template() -> None:
    ...
    client = get_client(test_id)
    client.summary.get_template(id="id")
...
def test_summary_update_template() -> None:
    ...
    client.summary.update_template(
        id="id", name="name", template="template", target_resources=["target_resources"], mode="mode"
    )
...
def test_summary_delete_template() -> None:
    ...
    client = get_client(test_id)
    client.summary.delete_template(id="id")
...
def test_summary_create() -> None:
    ...
    client = get_client(test_id)
    client.summary.create(fhir_resources={"resource_type": "resourceType"})
