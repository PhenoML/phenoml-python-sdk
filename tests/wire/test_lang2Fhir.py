...
def test_lang2Fhir_create() -> None:
    ...
    client.lang2fhir.create(version="R4", resource="auto", text="Patient has severe asthma with acute exacerbation")
...
def test_lang2Fhir_search() -> None:
    ...
    client = get_client(test_id)
    client.lang2fhir.search(text="Appointments between March 2-9, 2025")
...
def test_lang2Fhir_upload_profile() -> None:
    ...
    client = get_client(test_id)
    client.lang2fhir.upload_profile(profile="(base64 encoded FHIR StructureDefinition JSON)")
...
def test_lang2Fhir_document() -> None:
    ...
    client = get_client(test_id)
    client.lang2fhir.document(version="R4", resource="questionnaire", content="content")
...
def test_lang2Fhir_extract_multiple_fhir_resources_from_a_document() -> None:
    ...
    client = get_client(test_id)
    client.lang2fhir.extract_multiple_fhir_resources_from_a_document(version="R4", content="content")
