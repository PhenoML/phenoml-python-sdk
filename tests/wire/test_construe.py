...
def test_construe_upload_code_system() -> None:
    ...
    client.construe.upload_code_system(name="CUSTOM_CODES", version="1.0", format="csv")
...
def test_construe_get_code_system_detail() -> None:
    ...
    client = get_client(test_id)
    client.construe.get_code_system_detail(codesystem="ICD-10-CM", version="2025")
...
def test_construe_delete_custom_code_system() -> None:
    ...
    client = get_client(test_id)
    client.construe.delete_custom_code_system(codesystem="CUSTOM_CODES", version="version")
...
def test_construe_export_custom_code_system() -> None:
    ...
    client = get_client(test_id)
    client.construe.export_custom_code_system(codesystem="CUSTOM_CODES", version="version")
...
def test_construe_list_codes_in_a_code_system() -> None:
    ...
    client = get_client(test_id)
    client.construe.list_codes_in_a_code_system(codesystem="ICD-10-CM", version="2025", cursor="cursor", limit=1)
...
def test_construe_get_a_specific_code() -> None:
    ...
    client = get_client(test_id)
    client.construe.get_a_specific_code(codesystem="ICD-10-CM", code_id="E11.65", version="version")
...
def test_construe_terminology_server_text_search() -> None:
    ...
    client = get_client(test_id)
    client.construe.terminology_server_text_search(codesystem="ICD-10-CM", q="E11.65", version="version", limit=1)
    verify_request_count(
